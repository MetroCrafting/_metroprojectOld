...
public final class N2ConfigApi {
    ...
    public static File registerCustomConfigDirectory(String directoryPath, String directoryID) {
        ...
        if (directoryID != null) if (DirectoryList.containsKey(directoryID))
     ...
     * @param directoryPath   - This is the path inside the ParentDirectory. (Illegal DirectoryNames: "/temp")
     * @param directoryID     - With this ID you can retrieve the Instance of the Directory.
     * @return - File(Directory)
     */
    ...
    /**
     * @return - The Minecraft MainFileDirectory (don't use this for "registerCustomDirectory()", it will be added
     *         Automatically)
     */
    ...
    /**
     * @return - The MainDirectory of the WorldFile. Warning, calling this when a world isn't loaded will return null,
     *         or may even cause a crash! Also be very careful when you're modding for multiWorld servers!
     */
    ...
    public static String[] getDirContentConfigNames(File directory) {
        ...
        for (int i = 0; i < totalList.length; i++) {
            ...
            if (currentName.endsWith(".cfg")) finalList.add(currentName.substring(0, currentName.length() - 4));
        }
    ...
    /**
     * @param directory
     * @return - The names of all the Files(and Directory's) inside this Directory Note, this includes extensions!
     */
    ...
    public static String getFileIDFromFileDir(File FileDirectory) {
        ...
        while (fileID.hasNext()) {
            ...
            if (DirectoryList.get(currentString).equals(FileDirectory)) return currentString;
        }
        return null;
    }
