...
public class ConfigSectionCollection extends ConfigSection implements Serializable {
     ...
     * @return
     */
    public final ConfigSection addNewConfigSectionCollection(String sectionName, String[] description,
            boolean setExtraSpaces) {
        ConfigSection configSection = new ConfigSectionCollection(
                sectionName,
                description,
                setExtraSpaces,
                this.level + 1);
     ...
     * @return
     */
    public final ConfigSection addNewShortSection(String sectionName, String[] description, short defaultValue,
            boolean hideOutLines) {
     ...
     * @return
     */
    public final ConfigSection addNewShortArraySection(String sectionName, String[] description, short[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                SectionType.ShortArray,
                separateLines,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
     ...
     * @return
     */
    public final ConfigSection addNewIntegerSection(String sectionName, String[] description, int defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.Integer,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewIntegerArraySection(String sectionName, String[] description, int[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.IntegerArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewLongSection(String sectionName, String[] description, long defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.Long,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewLongArraySection(String sectionName, String[] description, long[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.LongArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewFloatSection(String sectionName, String[] description, float defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.Float,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewFloatArraySection(String sectionName, String[] description, float[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.FloatArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewDoubleSection(String sectionName, String[] description, double defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.Double,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewDoubleArraySection(String sectionName, String[] description, double[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.DoubleArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewBooleanSection(String sectionName, String[] description, boolean defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.Boolean,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewBooleanArraySection(String sectionName, String[] description,
            boolean[] defaultValue, boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.BooleanArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewStringSection(String sectionName, String[] description, String defaultValue,
            boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.String,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
     ...
     * @return
     */
    public final ConfigSection addNewStringArraySection(String sectionName, String[] description, String[] defaultValue,
            boolean separateLines, boolean hideOutLines) {
        ConfigSection configSection = new ConfigSection(
                sectionName,
                description,
                defaultValue,
                ConfigSection.SectionType.StringArray,
                hideOutLines);
        addNewSection(configSection);
        return configSection;
    }
    ...
    public final void addNewSection(ConfigSection configSection) {
        ...
        if (!this.subSectionMap.containsKey(sectionName)) {
            if (this.superConfigSectionCollection != null) if (!this.superConfigSectionCollection.insertConfigSection(
                    configSection,
                    this.superConfigSectionCollection.getConfigSectionAtIndex(
                            this.superConfigSectionCollection.getConfigSectionIndex(this.getSectionName()) + 1)))
                return;
    ...
    public final boolean insertConfigSection(ConfigSection insertConfigSection, ConfigSection configSectionTarget) {
        if (this.AbsoluteSubSectionMap.containsValue(insertConfigSection)
                || this.AbsoluteSubSectionMap.containsKey(insertConfigSection.getSectionName()))
            return false;
    ...
    private boolean superInsertConfigSection(ConfigSection insertConfigSection, ConfigSection configSectionTarget) {
        ...
        if (this.subSectionMap.containsValue(configSectionTarget)) {
            ...
            if (insertConfigSection instanceof ConfigSectionCollection) {
                ...
                for (int ii = 0; ii < subSectionCount; ii++) {
                    if (!superInsertConfigSection(
                            ((ConfigSectionCollection) insertConfigSection).getConfigSectionAtIndex(ii),
                            configSectionTarget)) {
        ...
        for (int ip = 0; ip < this.subSectionOrderList.size(); ip++) {
            ...
            if (configSection instanceof ConfigSectionCollection) {
                if (((ConfigSectionCollection) configSection)
                        .superInsertConfigSection(insertConfigSection, configSectionTarget)) {
                    this.AbsoluteSubSectionMap.put(insertConfigSection.getSectionName(), insertConfigSection);
    ...
    public final boolean removeSubConfigSection(String configSectionName) {
        if (!this.AbsoluteSubSectionMap.containsKey(configSectionName)) return false;
        if (this.superConfigSectionCollection != null)
            ...
            if (this.subSectionOrderList.contains(getConfigSectionAtIndex(getConfigSectionIndex(configSectionName)))) {
                ...
                for (int i = 0; i < this.subSectionMap.size(); i++) {
                    if (this.subSectionOrderList.get(i) instanceof ConfigSectionCollection)
                        if (((ConfigSectionCollection) this.subSectionOrderList.get(i))
                                .superRemoveSubConfigSection(configSectionName)) {
                                    this.AbsoluteSubSectionMap.remove(configSectionName);
                                    setChangedDefaultValue(true);
                                    return true;
                                }
    ...
    public final ConfigSection getSubSection(String sectionName) {
        if (this.subSectionMap.containsKey(sectionName)) return this.subSectionMap.get(sectionName);
        else {
    ...
    /**
     * @return - The Number of ConfigSections which are stored in this ConfigSectionCollection, including the 'nested'
     *         ConfigSections.
     */
    public final int getAbsoluteSubSectionCount() {
        ...
        while (currentSectionName.hasNext()) {
            if (this.subSectionMap.get(currentSectionName.next()) instanceof ConfigSectionCollection)
                finalAmount += ((ConfigSectionCollection) this.subSectionMap.get(currentSectionName.next()))
                        .getAbsoluteSubSectionCount();
        }
    ...
    /**
     * @param index
     * @return - The configSection inside this ConfigSectionCollection at index (including 'nested' ConfigSections). if
     *         index is 0 or lower it will return this ConfigSectionCollection.
     */
    public final ConfigSection getConfigSectionAtAbsoluteIndex(int index) {
        int corrector = 0;
        ConfigSection finalsection = null;

        if (index > this.subSectionOrderList.size()) return null;
        ...
        for (int i = 0; i <= (index - 1 - corrector); i++) {
            ...
            if (section instanceof ConfigSectionCollection) {
                for (int il = 0; il <= (index - i); il++) {
                    ...
                    if (finalsection == null) corrector += ((ConfigSectionCollection) section).getSubSectionCount();
                }
            } else {
    ...
    /**
     * @param index
     * @return The ConfigSection inside this ConfigSectionCollection at index (excluding 'nested' ConfigSections). if
     *         index is 0 or lower it will return this ConfigSectionCollection.
     */
    public final ConfigSection getConfigSectionAtIndex(int index) {
        ...
        if (index > 0) return configSection;
        else return this;
    }
    ...
    public final int getAbsoluteConfigSectionIndex(String ConfigSectionName) {
        ...
        if (target != null) {
            ...
            for (int i = 0; i < this.subSectionOrderList.size(); i++) {
                ...
                if (section.equals(target)) return i + 1;
    ...
    /**
     * @param ConfigSectionName
     * @return The index of this ConfigSectionCollection, or -1 if it can't be found. (excluding 'nested'
     *         ConfigSections)
     */
    public final int getConfigSectionIndex(String ConfigSectionName) {
        ...
        if (target != null) {
            for (int i = 0; i < this.subSectionOrderList.size(); i++) {
                if (this.subSectionOrderList.get(i).equals(target)) return i + 1;
            }
        }
        return -1;
    }
    ...
    /**
     * @return - The ConfigSectionCollection where this ConfigSectionCollection is 'nested' in. If non exist, it will
     *         return null.
     */
     ...
     * @throws IOException
     */
    public final int regenConfigChapter(BufferedWriter writer, BufferedReader reader, List invalidSections)
            throws IOException {
        ...
        if (superSectionCollection instanceof ConfigFile)
            if (((ConfigFile) superSectionCollection).isConnected()) return -1;
                ...
                for (int i = 0; i < this.subSectionOrderList.size(); i++) {
                    ...
                    try {
                        if (section.getSectionName()
                                .equals(readedLine.trim().substring(0, readedLine.trim().indexOf(";")))) {
                            if (section.getSectionType() == SectionType.Text
                                    || section.getSectionType() == SectionType.SectionHead)
                                continue;
                            else {
                                if (!invalidSections.contains(section.getSectionName())) {
                                    ...
                                    if (section.getSectionType().isArray()) {
                                            ...
                                            if (s2.length() > 0 && !s2.contains(section.getSectionName())) {
                                                while (readedLine != null) {
                                                    if (readedLine.contains(";{") && readedLine.contains("};")) {
                                                        String s3 = readedLine.substring(
                                                                readedLine.indexOf("{") + 1,
                                                                readedLine.indexOf("}"));
                                                        SB1.append(s3);
                                                        break;
                                        ...
                                        for (String s5 : s4) {
                                            if (s5.length() > 0) value.add(value.size(), s5);
                                        }
                                    } else {
                                        Pattern p1 = Pattern.compile(";");
                                        String[] s1 = p1.split(readedLine);
        ...
        for (int il = 0; il < this.subSectionOrderList.size(); il++) {
            ...
            if (currentSection instanceof ConfigSectionCollection)
                totalSectionsChecked += ((ConfigSectionCollection) currentSection)
                        .regenConfigChapter(writer, reader, invalidSections) + 1;
            else {
                if (sectionValues.containsKey(currentSection.getSectionName())) {
                    ...
                    if (currentSection.getSectionType().isArray()) {
                        ...
                        for (int iu = 0; iu < values.length; iu++) {
                            if (currentSection.getSeparteLines()) writer.newLine();
                            appendLineWithOffset(writer, values[iu] + ", ", this.level + 1);
                        }
                        if (currentSection.getSeparteLines()) writer.newLine();
                        appendLineWithOffset(writer, "};", this.level + 1);
                    } else {
                        appendLineWithOffset(
                                writer,
                                currentSection.getSectionName() + "; " + values[0],
                                this.level + 1);
                    }
                    writer.newLine();
            ...
            if (this.ExtraSpaces) writer.newLine();
        }
    ...
    public final void writeAllSections(BufferedWriter writer) throws IOException {
        ...
        while (superSectionCollection.superConfigSectionCollection != null)
            superSectionCollection = superSectionCollection.superConfigSectionCollection;
        if (superSectionCollection instanceof ConfigFile)
            if (((ConfigFile) superSectionCollection).isConnected()) return;
    ...
    private void writeSectionChapter(BufferedWriter writer, ConfigSectionCollection section) throws IOException {
        ...
        for (int i = 0; i < this.subSectionOrderList.size(); i++) {
            ...
            if (subSection != null) if (subSection instanceof ConfigSectionCollection)
                ((ConfigSectionCollection) subSection).writeAllSections(writer);
            else writeSubSection(writer, subSection);

            if (section.ExtraSpaces) writer.newLine();
        }
        ...
        if (sectionType != SectionType.Text) {
            if (sectionType.isArray()) {
                if (section.getDefaultValue() != null) {
                    ...
                    if (section.getSeparteLines()) writer.newLine();

                    switch (sectionType) {
                        case ShortArray:
                            short[] shortValues = (short[]) section.getDefaultValue();
                            for (int i = 0; i < shortValues.length; i++) {
                                if (!section.getSeparteLines()) writer.append(Short.toString(shortValues[i]) + ", ");
                                else {
                        ...
                        case IntegerArray:
                            ...
                            for (int i = 0; i < intValues.length; i++) {
                                if (!section.getSeparteLines()) writer.append(Integer.toString(intValues[i]) + ", ");
                                else {
                        ...
                        case LongArray:
                            ...
                            for (int i = 0; i < longValues.length; i++) {
                                if (!section.getSeparteLines()) writer.append(Long.toString(longValues[i]) + ", ");
                                else {
                        ...
                        case FloatArray:
                            ...
                            for (int i = 0; i < floatValues.length; i++) {
                                if (!section.getSeparteLines()) writer.append(Float.toString(floatValues[i]) + ", ");
                                else {
                        ...
                        case DoubleArray:
                            ...
                            for (int i = 0; i < doubleValues.length; i++) {
                                if (!section.getSeparteLines()) writer.append(Double.toString(doubleValues[i]) + ", ");
                                else {
                        ...
                        case StringArray:
                            ...
                            for (int i = 0; i < values.length; i++) {
                                if (!section.getSeparteLines()) writer.append(values[i] + ", ");
                                else {
                    ...
                    if (section.getSeparteLines()) appendLineWithOffset(writer, "};", (1 + this.level));
                    else writer.append("};");
                ...
                if (section.getDefaultValue() != null) {
                    switch (sectionType) {
                        ...
                        default:
                            log.error(
                                    "Did something go wrong? tried wrinting an primitive dataType while input wasn't an primitive dataType");
                            break;
                    }
                    writer.newLine();
                    writer.flush();
    ...
    protected final boolean readAndSaveValues(String fileName) throws IOException {
        ConfigSectionCollection superSectionCollection = this.superConfigSectionCollection;
        if (superSectionCollection != null) while (superSectionCollection.superConfigSectionCollection != null)
            superSectionCollection = superSectionCollection.superConfigSectionCollection;
        else superSectionCollection = this;
        if (superSectionCollection instanceof ConfigFile)
            if (((ConfigFile) superSectionCollection).isConnected()) return false;
        ...
        if (!InitConfigObjectManager.ConfigList.containsKey(fileName)) InitConfigObjectManager.addConfigFile(fileName);
        ...
        while (section.hasNext()) {
            ...
            if (exist) {
                ...
                InitConfigObjectManager.addField(
                        config,
                        currentSection.getSectionName(),
                        getValue(currentSection.getSectionName(), reader));
                ConfigHandler.getConfigFileFromName(fileName).closeReader(reader);
            } else InitConfigObjectManager
                    .addField(config, currentSection.getSectionName(), getValue(currentSection.getSectionName(), null));
            if (currentSection.getChangedDefaultValue()) hasChangedConfigSections = true;
        }
    ...
    private final Object getValue(String sectionName, BufferedReader reader) throws IOException {
        ...
        if (reader == null) return configSection.getDefaultValue();

        getValueLoop: while ((readedLine = reader.readLine()) != null) {
            if (readedLine.contains(";")
                    ? readedLine.trim().substring(0, readedLine.trim().indexOf(";")).equals(sectionName)
                    : false) {

                Pattern p1;
                if (sectiontype.isArray()) p1 = Pattern.compile(";\\{");
                        ...
                        for (String s3 : s2) {
                            if (sectiontype.isArray()) {
                                if (s3.length() > 2 && s3.endsWith("};")) {
                                    ...
                                    hasEnder = true;
                                } else if (s3.endsWith("};")) hasEnder = true;
                                else SB1.append(s3);
                            ...
                            if (sectiontype.isArray() && !hasEnder) {
                                ...
                                addArrayValues: while ((readedLine = reader.readLine()) != null) {
                                ...
                                switch (sectiontype) {
                                    ...
                                    case ShortArray:
                                        ...
                                        for (String shortS2 : shortS1) {
                                            if (shortS2.length() > 0) {
                                                try {
                                                    finalShortArrayValueMap.put(
                                                            finalShortArrayValueMap.size(),
                                                            Short.parseShort(shortS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalShortArrayValueMap.isEmpty()) return null;
                                            else {
                                                short[] finalShortArrayValue = new short[finalShortArrayValueMap
                                                        .size()];
                                            ...
                                            if (intS2.length() > 0) {
                                                try {
                                                    finalIntArrayValueMap
                                                            .put(finalIntArrayValueMap.size(), Integer.parseInt(intS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalIntArrayValueMap.isEmpty()) return null;
                                            else {
                                    ...
                                    case LongArray:
                                        ...
                                        for (String longS2 : longS1) {
                                            if (longS2.length() > 0) {
                                                try {
                                                    finalLongArrayValueMap
                                                            .put(finalLongArrayValueMap.size(), Long.parseLong(longS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalLongArrayValueMap.isEmpty()) return null;
                                            else {
                                    ...
                                    case FloatArray:
                                        ...
                                        for (String floatS2 : floatS1) {
                                            if (floatS2.length() > 0) {
                                                try {
                                                    finalFloatArrayValueMap.put(
                                                            finalFloatArrayValueMap.size(),
                                                            Float.parseFloat(floatS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalFloatArrayValueMap.isEmpty()) return null;
                                            else {
                                                float[] finalFloatArrayValue = new float[finalFloatArrayValueMap
                                                        .size()];
                                    ...
                                    case DoubleArray:
                                        ...
                                        for (String doubleS2 : doubleS1) {
                                            if (doubleS2.length() > 0) {
                                                try {
                                                    finalDoubleArrayValueMap.put(
                                                            finalDoubleArrayValueMap.size(),
                                                            Double.parseDouble(doubleS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalDoubleArrayValueMap.isEmpty()) return null;
                                            else {
                                                double[] finalDoubleArrayValue = new double[finalDoubleArrayValueMap
                                                        .size()];
                                    ...
                                    case BooleanArray:
                                        ...
                                        for (String booleanS2 : booleanS1) {
                                            if (booleanS2.length() > 0) {
                                                try {
                                                    finalBooleanArrayValueMap.put(
                                                            finalBooleanArrayValueMap.size(),
                                                            Boolean.parseBoolean(booleanS2));
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalBooleanArrayValueMap.isEmpty()) return null;
                                            else {
                                                boolean[] finalDoubleArrayValue = new boolean[finalBooleanArrayValueMap
                                                        .size()];
                                    ...
                                    case StringArray:
                                        ...
                                        for (String stringS2 : stringS1) {
                                            if (stringS2.length() > 0) {
                                                try {
                                                    finalStringArrayValueMap
                                                            .put(finalStringArrayValueMap.size(), stringS2);
                                                } catch (Exception e) {
                                                    log.catching(e);
                                                }
                                            }

                                            if (finalStringArrayValueMap.isEmpty()) return null;
                                            else {
                                                String[] finalStringArrayValue = new String[finalStringArrayValueMap
                                                        .size()];

                                                for (int i = 0; i < finalStringArrayValue.length; i++) {
                                                    finalStringArrayValue[i] = finalStringArrayValueMap.get(i);
                                                }
                                    ...
                                    default:
                                        log.error(
                                                "Did something go wrong? An Error ocured while trying to retrieve Value from: "
                                                        + sectionName
                                                        + "!");
                                        log.info(
                                                "Its recommended to check/regenerate the configFile while this might be caused by a faulty input.");
                                        break getValueLoop;
                                }
                            }
                        }
        ...
        log.error(
                "Couldn't find ConfigSection " + sectionName + " in the configFile!, returning Default value instead.");
