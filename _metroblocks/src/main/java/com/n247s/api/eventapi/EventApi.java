...
public class EventApi {
    ...
    /**
     * The instance of the EventApi, if you are not in the need to change the current behavior of the EventBus, use this
     * instance to Bind/Register/call Callhandlers and EventTypes
     */
