...
public class GuiScrollBox extends GuiControl {
    ...
    public void addControl(GuiControl control) {
        ...
        if (tempHeight > maxScroll) maxScroll = tempHeight;
    }
    ...
    public void drawControl(FontRenderer renderer) {
        ...
        if (isMouseOver()) {
            ...
            for (int k = 0; k < parent.controls.size(); k++) {
                if (parent.controls.get(k) == this) break;
            ...
            if (oneTop) gui.renderTooltip(renderer);
        }
        // GL11.glTranslated(0, scrolled, 0);
        ...
        RenderHelper2D.renderScrollBar(
                this.width - 15,
                1,
                maxScroll == 0 ? 0 : (double) scrolled / (double) maxScroll,
                this.height - 2,
                maxScroll <= 0);
    ...
    public void onScrolled() {
        ...
        if (this.scrolled > maxScroll) this.scrolled = maxScroll;
