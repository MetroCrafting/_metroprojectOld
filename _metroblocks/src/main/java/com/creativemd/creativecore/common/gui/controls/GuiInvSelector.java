...
public class GuiInvSelector extends GuiComboBox {
    ...
    @Override
    public void openBox() {
        extension = new GuiItemStackSelector(
                name + "extension",
                parent.container.player,
                posX,
                posY + height,
                width,
                200,
                ...
                onlyBlocks,
                search);
        // extension = new GuiInvSelectorExtension(name + "extension", parent.container.player, this, posX, posY+height,
        // width, 150, lines, stacks);
    ...
    public ItemStack getStack() {
        if (index != -1) return stacks.get(index);
        return null;
    }
