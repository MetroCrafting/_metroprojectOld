...
public class ConvertInfo extends StringConverter {
    ...
    public String toString(Object object) {
        ...
        return StringUtils.ObjectsToString(
                info.getClass().getName().replace("com.creativemd.creativecore.common.utils.stack", "$d$"),
                info.toString(),
                info.stackSize);
    }
    ...
    public Object parseObject(String input) {
        ...
        if (objects.length == 3) {
            ...
            for (int i = 0; i < StackInfo.loaders.size(); i++) {
                if (StackInfo.loaders.get(i).getClass().getName().equals(className)) loader = StackInfo.loaders.get(i);
            }
            StackInfo info = null;
            if (loader != null) {
            ...
            if (info != null) info.stackSize = (Integer) objects[2];
            return info;
        }
        return null;
    }
