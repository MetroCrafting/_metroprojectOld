...
public class ConvertItemStack extends StringConverter {
    ...
    public String toString(Object object) {
        ...
        else item = Block.blockRegistry.getNameForObject(Block.getBlockFromItem(stack.getItem()));
        if (stack.stackTagCompound == null)
            return StringUtils.ObjectsToString(item, stack.stackSize, stack.getItemDamage(), "null");
        else return StringUtils.ObjectsToString(item, stack.stackSize, stack.getItemDamage(), stack.stackTagCompound);
    }
    ...
    public Object parseObject(String input) {
        ...
        if (objects.length == 4 && objects[0] instanceof String
                ...
                && (objects[3] instanceof NBTTagCompound || objects[3] instanceof String)) {
            ...
            if (objects[3] instanceof NBTTagCompound) stack.stackTagCompound = (NBTTagCompound) objects[3];
            return stack;
        }
        return null;
    }
