...
public class GuiComboBoxExtension extends GuiListBox {
    ...
    public GuiComboBoxExtension(String name, EntityPlayer player, GuiComboBox comboBox, int x, int y, int width,
            int height, ArrayList<String> lines) {
    ...
    public void onLoseFocus() {
        if (!comboBox.isMouseOver()) comboBox.closeBox();
    }
