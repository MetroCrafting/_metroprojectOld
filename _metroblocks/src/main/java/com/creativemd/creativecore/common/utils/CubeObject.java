...
public class CubeObject {
    ...
    public static Vec3 getSizeOfCubes(ArrayList<CubeObject> cubes) {
        if (cubes.size() == 0) return Vec3.createVectorHelper(0, 0, 0);
    ...
    public static ArrayList<CubeObject> getFillBorder(CubeObject cube, double thicknessOutside,
            double thicknessInside) {
        ArrayList<CubeObject> cubes = new ArrayList<CubeObject>();
        cubes.add(
                new CubeObject(
                        cube.minX,
                        cube.minY + thicknessOutside,
                        cube.minZ + thicknessOutside,
                        cube.minX + thicknessInside,
                        cube.maxY - thicknessOutside,
                        cube.maxZ - thicknessOutside,
                        cube));
        int size = cubes.size();
    ...
    public static ArrayList<CubeObject> getBorder(CubeObject cube, double thicknessOutside, double thicknessInside) {
        ...
        cubes.add(
                new CubeObject(
                        ...
                        cube.minY,
                        cube.minZ,
                        cube.minX + thicknessOutside,
                        cube.maxY,
                        cube.minZ + thicknessInside,
                        cube));
        cubes.add(
                new CubeObject(
                        cube.minX,
        ...
        cubes.add(
                new CubeObject(
                        ...
                        cube.minZ + thicknessInside,
                        cube.maxX - thicknessOutside,
                        cube.minY + thicknessInside,
                        cube.minZ + thicknessOutside,
                        cube));
        cubes.add(
                new CubeObject(
                        cube.minX + thicknessInside,
                        cube.maxY - thicknessInside,
                        cube.minZ + thicknessInside,
                        cube.maxX - thicknessOutside,
                        cube.maxY,
                        cube.minZ + thicknessOutside,
        ...
        for (int i = 0; i < 6; i++) {
            ForgeDirection direction = ForgeDirection.getOrientation(i);
            if (direction != ForgeDirection.EAST && direction != ForgeDirection.UP
