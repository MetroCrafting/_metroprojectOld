...
public class RenderHelper2D {
    ...
    public static final ResourceLocation tab_item_search = new ResourceLocation(
    ...
    public static void renderItem(ItemStack stack, int x, int y, double alpha, double rotation, double sizeX,
            double sizeY) {
        if (stack != null) if (!ForgeHooksClient.renderInventoryItem(
                RenderHelper3D.renderer,
                mc.renderEngine,
                stack,
                true,
                zLevel,
    ...
    public static void renderIcon(IIcon icon, int x, int y, double alpha, boolean isBlock, double rotation,
    ...
    public static void renderItemIntoGUI(FontRenderer font, TextureManager texture, ItemStack stack, int x, int y,
            boolean renderEffect, double alpha, double rotation, double sizeX, double sizeY) {
        GL11.glPushMatrix();
    ...
    public static void drawRect(int x1, int y1, int x2, int y2, Vec3 color, double alpha) {
        ...
        /*
         * x1 += mc.displayWidth/4; x2 += mc.displayWidth/4; y1 += mc.displayHeight/4; y2 += mc.displayHeight/4;
         */
        int j1;
     ...
     * Draws a rectangle with a vertical gradient between the specified colors.
     */
    public static void drawGradientRect(int p_73733_1_, int p_73733_2_, int p_73733_3_, int p_73733_4_, Vector4d color1,
            Vector4d color2) {
        GL11.glDisable(GL11.GL_TEXTURE_2D);
        GL11.glEnable(GL11.GL_BLEND);
        GL11.glDisable(GL11.GL_ALPHA_TEST);
    ...
    public static void drawTexturedModalRect(double p_73729_1_, double p_73729_2_, double p_73729_3_, double p_73729_4_,
