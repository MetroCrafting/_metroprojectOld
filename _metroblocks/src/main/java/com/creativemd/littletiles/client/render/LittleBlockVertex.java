...
public class LittleBlockVertex {
    ...
    public ArrayList<LittleVertex> getAllSides() {
        ...
        if (XPos != null) sides.add(XPos);
        if (XNeg != null) sides.add(XNeg);
        if (YPos != null) sides.add(YPos);
        if (YNeg != null) sides.add(YNeg);
        if (ZPos != null) sides.add(ZPos);
        if (ZNeg != null) sides.add(ZNeg);
        return sides;
    }
        ...
        for (LittleVertex vertex : sides) {
            if (enableAO) {
                ...
                tessellator.setColorOpaque_F(
                        vertex.colorRedBottomLeft,
                        vertex.colorGreenBottomLeft,
                        vertex.colorBlueBottomLeft);
                ...
                tessellator.addVertexWithUV(
                        ...
                        vertex.coords[1][4]);
                tessellator.setColorOpaque_F(
                        vertex.colorRedBottomRight,
                        vertex.colorGreenBottomRight,
                        vertex.colorBlueBottomRight);
                ...
                tessellator.addVertexWithUV(
                        ...
                        vertex.coords[2][4]);
                tessellator
                        .setColorOpaque_F(vertex.colorRedTopRight, vertex.colorGreenTopRight, vertex.colorBlueTopRight);
