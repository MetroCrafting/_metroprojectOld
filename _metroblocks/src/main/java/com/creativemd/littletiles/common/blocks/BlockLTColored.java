...
public class BlockLTColored extends Block {
    ...
    public static final String[] subBlocks = new String[] { "clean", "floor", "grainybig", "grainy", "grainylow",
            "brick", "bordered", "brickBig", "structured", "brokenBrickBig", "clay" };
    ...
    public IIcon getIcon(int side, int meta) {
        if (meta > 0 && meta < subBlocks.length) return textures[meta];
