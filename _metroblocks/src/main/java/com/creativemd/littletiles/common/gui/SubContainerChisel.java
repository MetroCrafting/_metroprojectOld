                        ...
                        if (tileEntity instanceof TileEntityLittleTiles) {
                            ...
                            for (int i = 0; i < tiles.size(); i++) {
                                ...
                                boolean shouldEffect = tile.getClass() == LittleTileBlock.class
                                        || tile instanceof LittleTileBlockColored;
                                if (filter != null) {
                                    if (((LittleTileBlock) tile).block != filter) shouldEffect = false;
                                    if (meta != -1 && ((LittleTileBlock) tile).meta != meta) shouldEffect = false;
                                }
                                ...
                                if (shouldEffect) {
                                    ...
                                    if (replacement != null) {
                                        ...
                                        if (metaReplacement != -1) ((LittleTileBlock) tile).meta = metaReplacement;
                                        littleEntity.needFullUpdate = true;
                                    }

                                    if (colorize) {
                                        LittleTile newTile = LittleTileBlockColored
                                                .setColor((LittleTileBlock) tile, color);
