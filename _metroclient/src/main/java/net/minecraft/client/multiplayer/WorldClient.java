...
public class WorldClient extends World
{
    ...
    public WorldClient(NetHandlerPlayClient p_i45063_1_, WorldSettings p_i45063_2_, int p_i45063_3_, EnumDifficulty p_i45063_4_, Profiler p_i45063_5_)
    {
        ...
        super.difficultySetting = p_i45063_4_;
        super.mapStorage = p_i45063_1_.mapStorageOrigin;
        this.isRemote = true;
        this.finishSetup();
    ...
    public void doVoidFogParticles(int par1, int par2, int par3) {
        ...
        for(int var6 = 0; var6 < 1000; ++var6) {
              int var7 = par1 + super.rand.nextInt(var4) - super.rand.nextInt(var4);
              int var8 = par2 + super.rand.nextInt(var4) - super.rand.nextInt(var4);
              int var9 = par3 + super.rand.nextInt(var4) - super.rand.nextInt(var4);
     ...
     */
      ...
      public void setWorldScoreboard(Scoreboard par1Scoreboard) {
          super.worldScoreboard = par1Scoreboard;
    }
