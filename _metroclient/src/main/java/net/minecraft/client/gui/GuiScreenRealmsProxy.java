...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    {
        this.field_154330_a.render(mouseX, mouseY, partialTick);
    }
    ...
    {
        this.field_154330_a.mouseReleased(mouseX, mouseY, which);
    }
    ...
    {
        this.field_154330_a.mouseDragged(mouseX, mouseY, lastButtonClicked, timeSinceMouseClick);
    }
    ...
    {
        this.field_154330_a.keyPressed(character, key);
    }
