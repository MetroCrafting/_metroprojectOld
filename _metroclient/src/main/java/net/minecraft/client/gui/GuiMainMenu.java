...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2f - 100, i + 72 + 12, 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2f + 2, i + 72 + 12, 98, 20, I18n.format("menu.quit")));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2f - 100, p_73969_1_, I18n.format("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, this.width / 2f - 100, p_73969_1_ + p_73969_2_, I18n.format("menu.multiplayer")));
        GuiButton realmsButton = new GuiButton(14, this.width / 2f - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online"));
        GuiButton fmlModButton = new GuiButton(6, this.width / 2f - 100, p_73969_1_ + p_73969_2_ * 2, "Mods");
        fmlModButton.xPosition = this.width / 2f + 2;
    ...
    {
        this.buttonList.add(new GuiButton(11, this.width / 2f - 100, p_73972_1_, I18n.format("menu.playdemo")));
        this.buttonList.add(this.buttonResetDemo = new GuiButton(12, this.width / 2f - 100, p_73972_1_ + p_73972_2_, I18n.format("menu.resetdemo")));
    ...
    {
        GL11.glDisable(GL11.GL_ALPHA_TEST);
        this.renderSkybox(mouseX, mouseY, partialTick);
        GL11.glEnable(GL11.GL_ALPHA_TEST);
        Tessellator tessellator = Tessellator.instance;
        short short1 = 274;
        ...
        if (this.field_92025_p != null && this.field_92025_p.length() > 0)
        {
            ...
            this.drawString(this.fontRendererObj, this.field_146972_A, (this.width - this.field_92024_r) / 2f, ((GuiButton)this.buttonList.get(0)).yPosition - 12, -1);
        }
