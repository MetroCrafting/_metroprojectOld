...
public class GuiEditSign extends GuiScreen
{
    ...
    public void keyTyped(char character, int key)
    {
        ...
        if (key == 14 && this.tileSign.signText[this.editLine].length() > 0)
        {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter(character) && this.tileSign.signText[this.editLine].length() < 15)
        {
            this.tileSign.signText[this.editLine] = this.tileSign.signText[this.editLine] + character;
        }
