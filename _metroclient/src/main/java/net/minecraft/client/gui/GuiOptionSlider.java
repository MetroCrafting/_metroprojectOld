...
public class GuiOptionSlider extends GuiButton
{
    ...
    public GuiOptionSlider(int id, float x, float y, GameSettings.Options p_i45016_4_)
    {
        this(id, x, y, p_i45016_4_, 0.0F, 1.0F);
    }

    public GuiOptionSlider(int id, float x, float y, GameSettings.Options p_i45017_4_, float p_i45017_5_, float p_i45017_6_)
    {
        super(id, x, y, 150, 20, "");
