...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(FontRenderer p_i1032_1_, float p_i1032_2_, float p_i1032_3_, float p_i1032_4_, float p_i1032_5_)
    {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (k != j)
            {
                float l1 = l + this.fontRenderer.getStringWidth(s.substring(0, k));
     ...
     */
    protected void drawCursorVertical(float p_146188_1_, float p_146188_2_, float p_146188_3_, float p_146188_4_)
    {
        float i1;
        ...
        GL11.glColor4f(0.0F, 0.0F, 1f, 0.4f);
