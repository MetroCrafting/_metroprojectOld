...
public class RenderBlocks
{
        ...
        else
        {
            try
            {
                ...
                switch (i)
                {
                    ...
                    case 22:
                    default:
                        return FMLRenderAccessLibrary.renderWorldBlock(this, blockAccess, par2, par3, par4, par1Block, i);
                    case 23:
    ...
    public boolean renderBlockBed(Block p_147773_1_, int p_147773_2_, int p_147773_3_, int p_147773_4_)
    {
        ...
        int var7 = p_147773_1_.getBedDirection(blockAccess, p_147773_2_, p_147773_3_, p_147773_4_);
        boolean var8 = p_147773_1_.isBedFoot(blockAccess, p_147773_2_, p_147773_3_, p_147773_4_);
    ...
    public boolean renderBlockFire(BlockFire p_147801_1_, int p_147801_2_, int p_147801_3_, int p_147801_4_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_) && !Blocks.fire.canCatchFire(this.blockAccess, p_147801_2_, p_147801_3_ - 1, p_147801_4_, ForgeDirection.UP))
        {
            float var36 = 0.2F;
            float var19 = 0.0625F;
    ...
    public boolean renderBlockStainedGlassPane(Block block, int x, int y, int z)
    {
        ...
        boolean connZNeg = isStainedGlass1 ? ((BlockStainedGlassPane)block).canPaneConnectTo(this.blockAccess, x, y, z - 1, NORTH) : ((BlockPane)block).canPaneConnectTo(this.blockAccess, x, y, z - 1, NORTH);
        boolean connZPos = isStainedGlass1 ? ((BlockStainedGlassPane)block).canPaneConnectTo(this.blockAccess, x, y, z + 1, SOUTH) : ((BlockPane)block).canPaneConnectTo(this.blockAccess, x, y, z + 1, SOUTH);
        boolean connXNeg = isStainedGlass1 ? ((BlockStainedGlassPane)block).canPaneConnectTo(this.blockAccess, x - 1, y, z, WEST) : ((BlockPane)block).canPaneConnectTo(this.blockAccess, x - 1, y, z, WEST);
        boolean connXPos = isStainedGlass1 ? ((BlockStainedGlassPane)block).canPaneConnectTo(this.blockAccess, x + 1, y, z, EAST) : ((BlockPane)block).canPaneConnectTo(this.blockAccess, x + 1, y, z, EAST);
        double var58 = 0.001D;
        double var60 = 0.999D;
        double var62 = 0.001D;
    ...
    public boolean renderBlockPane(BlockPane p_147767_1_, int p_147767_2_, int p_147767_3_, int p_147767_4_)
    {
        ...
        boolean var53 = p_147767_1_.canPaneConnectTo(this.blockAccess, p_147767_2_, p_147767_3_, p_147767_4_ - 1, NORTH);
        boolean var54 = p_147767_1_.canPaneConnectTo(this.blockAccess, p_147767_2_, p_147767_3_, p_147767_4_ + 1, SOUTH);
        boolean var55 = p_147767_1_.canPaneConnectTo(this.blockAccess, p_147767_2_ - 1, p_147767_3_, p_147767_4_, WEST);
        boolean var56 = p_147767_1_.canPaneConnectTo(this.blockAccess, p_147767_2_ + 1, p_147767_3_, p_147767_4_, EAST);
        ...
        else
        {
            ...
            for (int var571 = 0; var571 < 4; ++var571)
            {
                ...
                if (this.renderAllFaces || var12[var571])
                {
                    ...
                    var5.setBrightness(p_147721_1_.getMixedBrightnessForBlock(this.blockAccess, var581, p_147721_3_, var591));
                    float var61 = 1.0F;
