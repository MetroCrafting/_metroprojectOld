...
public class RandomMobs {
      ...
      private static RandomMobsProperties makeProperties(ResourceLocation loc) {
            ...
            ResourceLocation[] variants = getTextureVariants(loc);
      ...
      private static RandomMobsProperties parseProperties(ResourceLocation propLoc, ResourceLocation resLoc) {
            try {
                  String path = propLoc.getResourcePath();
                  Config.dbg("RandomMobs: " + resLoc.getResourcePath() + ", variants: " + path);
      ...
      private static ResourceLocation[] getTextureVariants(ResourceLocation loc) {
            ...
            if (locMcp == null) {
                  ...
                  if (list.size() <= 1) {
                        ...
                        Config.dbg("RandomMobs: " + loc.getResourcePath() + ", variants: " + locs.length);
                        return locs;
                  }
            }
      }
