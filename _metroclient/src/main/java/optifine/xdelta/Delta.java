...
public class Delta {
      ...
      public static void computeDelta(SeekableSource source, InputStream targetIS, int targetLength, DiffWriter output) throws DeltaException, IOException {
      ...
      public static void computeDelta(byte[] source, InputStream targetIS, int targetLength, DiffWriter output) throws DeltaException, IOException {
            computeDelta((SeekableSource)(new ByteArraySeekableSource(source)), targetIS, targetLength, output);
      }

      public static void computeDelta(File sourceFile, File targetFile, DiffWriter output) throws DeltaException, IOException {
